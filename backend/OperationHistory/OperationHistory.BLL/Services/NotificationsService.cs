...
public class NotificationsService {
    ...
    public async Task SendFirebase(OperationHistoryMessage messageDto) {
        FirebaseApp.Create(new AppOptions() {
            Credential = GoogleCredential.FromFile("../../OperationHistory/OperationHistory.BLL/test-27676-firebase-adminsdk-xyxen-11d662c6eb.json")
        });
        ...
        var result = await messaging.SendEachAsync([new Message {
            Notification = new Notification {
                ...
                ImageUrl = "https://telegra.ph/file/1f2b6e7fadf56fb39c618.jpg"
            },
            Token =
