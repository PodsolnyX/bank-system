...
public class AccountInternalService
{
    ...
    public AccountInternalService(
        ...
        AccountBalanceService accountBalanceService, CurrencyTransferService transferService)
    {
    ...
    public async Task TransferMoneyInternal(Guid fromAccountId, Guid toAccountId, int amount, Guid? userId = null) {
        if (amount < 100)
